import type {StackModals} from "./lib";

export declare type DefaultModalName = string | number

export declare type ModalID = string

export declare type ModalScheme<ModalName extends DefaultModalName = DefaultModalName, P = unknown> = Record<
    ModalName,
...
export declare type AddModalFn<Scheme extends ModalScheme, InferName extends ModalNameType<Scheme> = ModalNameType<Scheme>> = <
...
export declare type UpdateModalFn<Scheme extends ModalScheme> = <Name extends ModalNameType<Scheme> = ModalNameType<Scheme>>(
    key: `${Name}:${ModalID}`,
...
export declare type CreateUniqModalKeyFn<Scheme extends ModalScheme> = <Name extends ModalNameType<Scheme>>(
    name: Name
